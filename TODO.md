...
- [x] Support explicit effect variants when useful, such as `ceiling`, `wall`, and `floor` staging for the same effect.
...
Goal:
Tune each effect until it has a clear visual identity on its own.
